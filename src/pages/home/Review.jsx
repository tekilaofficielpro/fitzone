...
const Review = () => {
    return (
        <section className="container mx-auto flex flex-col sm:flex-row sm:max-w-4/5 bg-tertiary justify-center items-center px-4 sm:px-8 lg:px-12 py-6 sm:py-0 sm:h-40 lg:mt-10 md:mt-5 gap-6 sm:gap-20 text-center border-l-8 border-red-700 mt-6 sm:mt-0">
                <div>
