    ...
    <section className='container h-[870px]'>
      <div className='container mx-2 mt-70'>
        <ul className='flex flex-row gap-x-[64px]'>
          <li>
            <div>
              <ul className='flex flex-col gap-y-[24px]'>
                <li ref={card1Ref}
                    className='w-[485px] h-[163px] border-1 rounded-[4px] border-[#5F3F3A]/15 bg-[#1C1B1B] p-8 reveal-left
                               transition-all duration-300 hover:border-[#E8000D]/50 hover:shadow-[0_0_20px_0_#E8000D20] hover:-translate-y-1'>
                ...
                <li ref={card2Ref}
                    className='w-[485px] h-[163px] border-1 rounded-[4px] border-[#5F3F3A]/15 bg-[#1C1B1B] p-8 reveal-left delay-1
                               transition-all duration-300 hover:border-[#E8000D]/50 hover:shadow-[0_0_20px_0_#E8000D20] hover:-translate-y-1'>
                ...
                <li ref={card3Ref}
                    className='w-[485px] h-[163px] border-1 rounded-[4px] border-[#5F3F3A]/15 bg-[#1C1B1B] p-8 reveal-left delay-2
                               transition-all duration-300 hover:border-[#E8000D]/50 hover:shadow-[0_0_20px_0_#E8000D20] hover:-translate-y-1'>
                ...
                <li ref={card4Ref}
                    className='w-[485px] h-[163px] border-1 rounded-[4px] border-[#5F3F3A]/15 bg-[#1C1B1B] p-8 reveal-left delay-3
                               transition-all duration-300 hover:border-[#E8000D]/50 hover:shadow-[0_0_20px_0_#E8000D20] hover:-translate-y-1'>
                ...
                <li ref={socialRef}
                    className='w-[485px] h-[64px] py-8 flex flex-row gap-x-4 items-center reveal delay-4'>
          ...
          <li ref={formRef}
              className='w-[720px] h-[622px] bg-[#1C1B1B] top-[96px] left-[533.33px] rounded-[4px] border-1 border-[#5F3F3A]/15 pt-[39.5px] pr-[40px] pb-[56px] pl-[40px] gap-[32px] col-start-6 col-span-7 row-start-1 row-span-1 reveal-right'>
              ...
              <ul className='flex flex-col gap-[24px]'>
                <li className='w-[616px] h-[81px] flex flex-row gap-[48px] text-white'>
                  <div className='w-[296px] h-[81px] flex flex-col gap-[8px]'>
                    ...
                    <input type="text" placeholder='JOHN DOE' className='w-[296px] h-[57px] px-[16px] py-[18px] bg-[#0E0E0E] border-1 border-[#5F3F3A]/20 radius-4 transition-colors duration-200 focus:outline-none focus:border-[#E8000D]/60'/>
                  </div>
                  <div className='w-[296px] h-[81px] flex flex-col gap-[8px]'>
                    <label htmlFor="" className='w-[90px] h-[15px] font-bold text-[10px] text-[#E9BCB6] leading-[15px] tracking-[1px] align-middle'>EMAIL</label>
                    <input type="email" placeholder='EMAIL@EXAMPLE.com' className='w-[296px] h-[57px] px-[16px] py-[18px] bg-[#0E0E0E] border-1 border-[#5F3F3A]/15 transition-colors duration-200 focus:outline-none focus:border-[#E8000D]/60'/>
                  </div>
                </li>
                <li className='w-[616px] h-[81px] flex flex-row gap-[48px] text-white'>
                  <div className='w-[296px] h-[81px] flex flex-col gap-[8px]'>
                    ...
                    <input type="text" placeholder='(123) 456-7890' className='w-[296px] h-[57px] px-[16px] py-[18px] bg-[#0E0E0E] border-1 border-[#5F3F3A]/15 transition-colors duration-200 focus:outline-none focus:border-[#E8000D]/60'/>
                  </div>
                  <div className='w-[296px] h-[81px] flex flex-col gap-[8px]'>
                    ...
                    <select name="" id="" className='w-[296px] h-[57px] px-[16px] py-[18px] bg-[#0E0E0E] border-1 border-[#5F3F3A]/15 transition-colors duration-200 focus:outline-none focus:border-[#E8000D]/60'>
                ...
                <li className='w-[616px] h-[81px] flex flex-row gap-[48px] text-white'>
                  <div className='w-[296px] h-[81px] flex flex-col gap-[8px]'>
                    ...
                    <textarea name="" id="" placeholder='TELL US YOUR GOALS...' className="w-[640.67px] h-[154px] opacity-100 rounded-[4px] border-[1px] border-[#5F3F3A]/15 px-[16px] pt-[16px] pb-[112px] bg-[#0E0E0E] overflow-hidden resize-none transition-colors duration-200 focus:outline-none focus:border-[#E8000D]/60"></textarea>
                  </div>
                </li>
                <li className="w-[616.67px] h-[68px] opacity-100 rounded-[4px] py-[20px] mt-15">
                  <button type="submit" className="w-[640px] h-[68px] opacity-100 rounded-[4px] py-[20px] bg-gradient-to-r from-[#FFB4A9] to-[#E8000D] text-white font-bold transition-all duration-300 hover:opacity-90 hover:scale-[1.02] active:scale-[0.98]">SEND MESSAGE</button>
                </li>
              </ul>
            </form>
          </li>
