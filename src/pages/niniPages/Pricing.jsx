...
const Pricing = () => {
  return (
    ...
    <section className='container relative w-[1680px] h-[450px] mx-1  py-24 px-120 flex flex-col justify-center items-center gap-16 '>
      <div 
    ...
    <section className='container w-[1280px] h-[750px] text-white'>
    ...
    <section className=" container w-[1685px] h-[738px] text-white py-[96px] px-[185px] bg-[#0E0E0E]">
    ...
    {/* FAQ Section */}
    <section className="container w-[1685px] h-[766px] text-white py-[96px] px-[402px] bg-[#131313]">
      <div className='w-[896px] h-[574px] max-w-[896px] flex flex-col gap-[64px]'>
        <div className='w-[896px] h-[40px]'>
          <h1 className='w-[354px] h-[40px]  font-black text-[36px] leading-[40px] tracking-[-1.8px] text-center position relative left-[265px]'>FREQUENTLY ASKED</h1>
        </div>
        <div className='w-[896px] h-[470px] max-w-[896px]'>
          <ul className='flex flex-col gap-[16px]'>
            <li className='w-[896px] h-[146px] border-[1px] rounded-[4px] border-[#FFFFFF]/5 p-[24px] flex flex-col gap-[16px] bg-[#1C1B1B]'>
              ...
              <p className='w-[846px] h-[52px] font-normal text-[16px] text-[#A0A0A0] leading-[26px] tracking-normal'>Yes, all of our plans are commitment-free on a month-to-month basis. You can cancel through your dashboard
              with a 30-day notice period.</p>
            ...
            <li className='w-[896px] h-[146px] border-[1px] rounded-[4px] border-[#FFFFFF]/5 p-[24px] flex flex-col gap-[16px] bg-[#1C1B1B]'>
              ...
              <p className='w-[846px] h-[52px] font-normal text-[16px] text-[#A0A0A0] leading-[26px] tracking-normal'>Absolutely not. We believe in transparency. The price you see is the price you pay, with no hidden sign-up or
            ...
            <li className='w-[896px] h-[146px] border-[1px] rounded-[4px] border-[#FFFFFF]/5 p-[24px] flex flex-col gap-[16px] bg-[#1C1B1B]'>
              ...
              <p className='w-[846px] h-[52px] font-normal text-[16px] text-[#A0A0A0] leading-[26px] tracking-normal'>We offer a 15% discount for verified students on our Pro plan. Bring your valid student ID to any of our locations
              to activate this rate.</p>
    ...
    {/* Section - Finale CTA */}
    <section className="flex items-center justify-center mx-auto w-full h-[516px] text-white py-[96px] px-[400px] bg-[#E8000D]">
